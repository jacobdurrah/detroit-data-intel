...
function getDealScore(deal) {
  if (deal.motivation_score != null) return deal.motivation_score;
  if (deal.score != null) return deal.score;
  return 0;
}
...
function renderPipelineTable() {
  ...
  APP.pipeline.forEach(deal => {
    ...
    const scoreClass = score >= 50 ? 'score-high' :
                       score >= 30 ? 'score-mid' : 'score-low';
